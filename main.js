...
function checkSketch(){
 timerCounter++;
 document.getElementById("timer").innerHTML='Tiempo: ' + timerCounter;
...
function gotResult(error,results){
    ...
    document.getElementById("label").innerHTML='Tu dibujo: ' + drawSketch;
